...
import { CalculateInterestRatesParams } from '../protocol/libraries/types/DataTypes.sol';
...
contract ZeroReserveInterestRateStrategy is IDefaultInterestRateStrategy {
    ...
    // Slope of the stable interest curve when usage ratio > 0 and <= OPTIMAL_USAGE_RATIO.
    // Expressed in ray
    ...
    */
    ...
    function calculateInterestRates(
        CalculateInterestRatesParams memory
