...
contract Pool is IPool, VersionedInitializable, PoolStorage {
    ...
    function _onlyPoolConfigurator() internal view virtual {
        require(
            IPoolAddressesProvider(ADDRESSES_PROVIDER).getPoolConfigurator() == msg.sender,
    ...
    function backUnbacked(
        ...
        return
            BridgeLogic.executeBackUnbacked({
                ...
                amount         : amount,
                fee            : fee,
                protocolFeeBps : _bridgeProtocolFee
            });
    }
    ...
    function withdraw(
        ...
        return
            SupplyLogic.executeWithdraw({
                reservesData    : _reserves,
                reservesList    : _reservesList,
                eModeCategories : _eModeCategories,
                userConfig      : _usersConfig[msg.sender],
                params          : ExecuteWithdrawParams({
                    asset             : asset,
                    amount            : amount,
                    to                : to,
                    reservesCount     : _reservesCount,
                    oracle            : IPoolAddressesProvider(ADDRESSES_PROVIDER).getPriceOracle(),
    ...
    function borrow(
        ...
        BorrowLogic.executeBorrow({
            ...
            params          : ExecuteBorrowParams({
                ...
                onBehalfOf                     : onBehalfOf,
                amount                         : amount,
                interestRateMode               : InterestRateMode(interestRateMode),
                referralCode                   : referralCode,
                releaseUnderlying              : true,
                maxStableRateBorrowSizePercent : _maxStableRateBorrowSizePercent,
                reservesCount                  : _reservesCount,
                oracle                         : IPoolAddressesProvider(ADDRESSES_PROVIDER)
                                                    .getPriceOracle(),
                userEModeCategory              : _usersEModeCategory[onBehalfOf],
                priceOracleSentinel            : IPoolAddressesProvider(ADDRESSES_PROVIDER)
    ...
    function repayWithPermit(
        ...
        {
            ExecuteRepayParams memory params = ExecuteRepayParams({
                asset            : asset,
                amount           : amount,
                interestRateMode : InterestRateMode(interestRateMode),
                onBehalfOf       : onBehalfOf,
    ...
    function setUserUseReserveAsCollateral(
        ...
        SupplyLogic.executeUseReserveAsCollateral(
            ...
            useAsCollateral,
            _reservesCount,
            IPoolAddressesProvider(ADDRESSES_PROVIDER).getPriceOracle(),
    ...
    function liquidationCall(
        ...
        LiquidationLogic.executeLiquidationCall(
            ...
            ExecuteLiquidationCallParams({
                ...
                priceOracle         : IPoolAddressesProvider(ADDRESSES_PROVIDER).getPriceOracle(),
                userEModeCategory   : _usersEModeCategory[user],
                priceOracleSentinel : IPoolAddressesProvider(ADDRESSES_PROVIDER).getPriceOracleSentinel()
            })
        );
    }
    ...
    function flashLoan(
        ...
        FlashloanParams memory flashParams = FlashloanParams({
            ...
            params                         : params,
            referralCode                   : referralCode,
            premiumToProtocol              : _flashLoanPremiumToProtocol,
            premiumTotal                   : _flashLoanPremiumTotal,
            maxStableRateBorrowSizePercent : _maxStableRateBorrowSizePercent,
            reservesCount                  : _reservesCount,
            ...
            isAuthorizedFlashBorrower      : IACLManager(
                                                IPoolAddressesProvider(ADDRESSES_PROVIDER).getACLManager()
    ...
    function flashLoanSimple(
        ...
        FlashloanSimpleParams memory flashParams = FlashloanSimpleParams({
            recipient         : recipient,
            asset             : asset,
            amount            : amount,
            params            : params,
    ...
    function getReserveData(
        address asset
    ) external view virtual override returns (ReserveData memory) {
    ...
    function getConfiguration(
        address asset
    ) external view virtual override returns (ReserveConfigurationMap memory) {
    ...
    function getUserConfiguration(
        address user
    ) external view virtual override returns (UserConfigurationMap memory) {
    ...
    function getReservesList()
        ...
        virtual
        override
        returns (address[] memory reservesList)
    {
    ...
    function setReserveInterestRateStrategyAddress(
        ...
        _reserves[asset].interestRateStrategy = rateStrategy;
    }
    ...
    function updateFlashloanPremiums(
        uint128 premiumTotal,
        uint128 premiumToProtocol
    ) external virtual override onlyPoolConfigurator {
        _flashLoanPremiumTotal      = premiumTotal;
        _flashLoanPremiumToProtocol = premiumToProtocol;
    }
    ...
    function getEModeCategoryData(
        uint8 id
    ) external view virtual override returns (EModeCategory memory) {
