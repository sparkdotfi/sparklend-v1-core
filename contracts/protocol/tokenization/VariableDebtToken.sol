 ...
 * @author Aave
 * @notice Implements a variable debt token to track the borrowing positions of users at variable
 *         rate mode
    ...
    function balanceOf(address user) public view virtual override returns (uint256) {
        ...
        return
            scaledBalance == 0
                ? 0
                : scaledBalance
                    .rayMul(IPool(POOL).getReserveNormalizedVariableDebt(_underlyingAsset));
    }
