    ...
    ICreditDelegationToken
{
    ...
    // Map of borrow allowances (delegator => delegatee => borrowAllowance)
    ...
    */
    ...
    /// @inheritdoc ICreditDelegationToken
    function borrowAllowance(address from, address to) external view override returns (uint256) {
        return _borrowAllowances[from][to];
    }
