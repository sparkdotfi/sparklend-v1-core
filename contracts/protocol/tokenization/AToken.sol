...
contract AToken is VersionedInitializable, ScaledBalanceTokenBase, EIP712Base, IAToken {
    ...
    function burn(
        ...
        if (receiverOfUnderlying == address(this)) return;
    ...
    /**
     * @notice Transfers the aTokens between two users. Validates the transfer (i.e. checks for\
     *         valid HF after the transfer) if required
