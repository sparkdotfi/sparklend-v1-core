 ...
 * @dev    Used for indexing purposes of Aave protocol's markets. The id assigned to a
 *         PoolAddressesProvider refers to the market it is connected with, for example with `1` for
 *         the Aave main market and `2` for the next created.
 */
contract PoolAddressesProviderRegistry is IPoolAddressesProviderRegistry, Ownable {
